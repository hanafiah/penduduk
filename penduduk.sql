...
-- Schema penduduk
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `penduduk` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `penduduk` ;
...
CREATE TABLE IF NOT EXISTS `penduduk`.`houses` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `owner_id` INT UNSIGNED NOT NULL COMMENT 'House Owner',
  `residents_id` INT UNSIGNED NOT NULL COMMENT 'Who stay at that house. can be rental or owner. only head of family/team',
  ...
  PRIMARY KEY (`id`, `owner_id`, `residents_id`),
